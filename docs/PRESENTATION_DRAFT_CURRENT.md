...
- 路由包括 papers、recommendation、topics、pipelines、content、agent、settings、jobs、auth。
...
说明用户画像如何影响搜索排序、论文库推荐和精读中的个性化分析。
...
说明统一多源检索、候选审核、主题归类和确认入库如何帮助用户持续收集论文。
...
- 用户画像保存后，论文收集、论文库推荐和精读个性化分析会读取画像。
